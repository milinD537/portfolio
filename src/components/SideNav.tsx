	...
	return (
		<div className={`flex gap-2 items-center flex-col xl:flex-row`}>
			<SliderTogglerBtn route={href}>
				...
				>
					<div
						className={`xl:overflow-hidden border-2 rounded-md p-1 transition-colors ${
							isActive
...
export default function SideNav() {
	...
	return (
		<div className="sideNav | z-50 grid xl:grid-cols-[auto_20px_auto] fixed left-1/2 -translate-x-1/2 bottom-4 xl:left-4 xl:translate-x-0 xl:bottom-auto xl:top-1/2 xl:-translate-y-1/2 bg-[hsl(0,0%,5%)] px-8 py-2 rounded-full border border-[hsl(0,0%,18%)] xl:p-0 xl:border-none xl:rounded-none xl:bg-transparent">
